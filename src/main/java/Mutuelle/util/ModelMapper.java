...
public class ModelMapper {
    ...
    public static LieuTravResponse mapLieuTravToLieuTravResponse (LieuTrav lieuTrav)
    {
        return  new LieuTravResponse(lieuTrav.getCode_li(),lieuTrav.getLib_lieu());
    }
    public static PlafondResponse mapPlafondToPlafondResponse (Plafond plafond)
    {
